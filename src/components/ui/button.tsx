...
export function Button({ children, variant = "primary", className = "", ...props }: ButtonProps) {
  const variantStyles = {
    primary: "border border-white px-8 py-3 rounded-xl hover:bg-white hover:text-slate-900 transition",
    secondary: "bg-blue-500 text-gray-900 border border-gray-300 hover:bg-gray-50",
